        ...
        <div className="relative overflow-hidden border border-[#222222] bg-[#FFFAEE] px-8 py-12 md:px-16 md:py-16">
          {topFlower && (
            <img
              ...
              alt=""
              aria-hidden="true"
              className="pointer-events-none absolute left-0 top-0 z-0 w-32 md:w-84 lg:w-84"
            />
          )}
          ...
          {bottomFlower && (
            <img
              ...
              alt=""
              aria-hidden="true"
              className="pointer-events-none absolute bottom-0 right-0 z-0 w-32 md:w-64 lg:w-72"
            />
          )}

            ...
            <div className="mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-10 md:grid-cols-[30%_70%] md:gap-12">
              <div className="flex justify-center overflow-hidden">
                <img
                  ...
                  className="w-[450px] sm:w-[450px] md:w-[360px] lg:w-[430px] object-contain scale-125"
                />
              </div>
              ...
              <div className="mx-auto flex w-full max-w-[720px] flex-col items-center space-y-10 px-1 md:space-y-12">
                ...
                >
                  ...
                  <span className={` ${antic.className} text-[clamp(1.5rem,9vw,7rem)]`}>
                    saber
                  </span>
                </h1>
                  ...
                  <div className="mb-8 flex justify-center md:justify-start">
                    <div className="flex items-center gap-4">
                      <h2 className="flex flex-col text-center font-bold leading-[0.9] md:text-left">
                        ...
                        <span className={`${antic.className} text-[clamp(1rem,9vw,3.5rem)]`}>Vestimenta</span>
                      </h2>
          ...
          <section id="hospedaje" className="px-6 py-24 text-center">
            <div className="mx-auto w-full max-w-5xl space-y-16">
              <div className="space-y-4">
                ...
                >
                  <span className={` ${antic.className} text-[clamp(1.5rem,7vw,2rem)]`}>
                    Opciones de
                  </span>

                  <span className={` ${antic.className} text-[clamp(1.5rem,10vw,3rem)]`}>
                    Hospedaje
                  </span>
                </h1>
                <br/>
